export namespace models {
    ...
    export class Task {
        ...
        constructor(source: any = {}) {
            ...
            this.skip_from = this.convertValues(source["skip_from"], null);
            this.skip_until = this.convertValues(source["skip_until"], null);
            this.created_at = this.convertValues(source["created_at"], null);
            this.updated_at = this.convertValues(source["updated_at"], null);
            this.remindText = source["remindText"];
            this.pausedToday = source["pausedToday"];
            this.isPaused = source["isPaused"];
            this.inSkipRange = source["inSkipRange"];
            this.pausedText = source["pausedText"];
            this.skipRangeText = source["skipRangeText"];
        }
...
export namespace requests {
    ...
    export class TaskCreateReq {
        ...
        constructor(source: any = {}) {
            ...
            this.weekdays = source["weekdays"];
            this.month_day = source["month_day"];
            this.paused_date = source["paused_date"];
            this.paused_until = source["paused_until"];
            this.skip_from = source["skip_from"];
            this.skip_until = source["skip_until"];
        }
    }
